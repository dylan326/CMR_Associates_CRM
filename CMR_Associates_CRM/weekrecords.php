...
?>
<html>
    <head><title>Week worth of records</title>
...
<h1>Here are the last 7 days of call logs</h1>
...
$sql = "SELECT logcall.logcall_id, details.name, logcall.time_called, logcall.date_called, logcall.what_happened from logcall inner join details on details.details_id = logcall.details_id WHERE createDate >= DATE_SUB(CURDATE(), INTERVAL 7 DAY) AND createDate <= CURDATE() ORDER BY createDate DESC";
